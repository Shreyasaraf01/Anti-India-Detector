...
const InlineWordCloud = ({ words }) => {
  // Normalize the word values to a reasonable font size range
  ...
  return (
    <div className="flex flex-wrap justify-center items-center p-4" style={{ height: '300px' }}>
      {words.map((word, index) => (
        <span
          ...
          style={{
            ...
            color: '#1f2937', // A dark gray color for visibility
...
// This is the component you provided, now integrated into the App.jsx file
